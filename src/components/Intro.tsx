  ...
  return (
    <section className="py-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-2">{t.intro.name}</h1>

          <p className="text-xl text-primary mb-6">{t.intro.role}</p>

          <div className="space-y-2 mb-8">
            <div className="flex items-center gap-3 text-muted">
              <MapPin className="w-4 h-4" />
              <span>{t.intro.location}</span>
            </div>
          ...
          <div className="border-l-4 border-primary bg-primary/5 rounded-r-lg px-6 py-4">
            <p className="text-muted">{t.intro.summary}</p>
          </div>
        </motion.div>
      </div>
    </section>
